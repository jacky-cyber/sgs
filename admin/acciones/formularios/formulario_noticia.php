...
$query = "SELECT id_tipo, descripcion
          	  ...
          	  ORDER BY 'id_tipo'";
//echo $query; 
		$result_p4 = cms_query($query)or die (error($query,mysql_error(),$php));
		while (list($id_tipo_noticia_bd, $descripcion) = mysql_fetch_row($result_p4)){
			
						if($id_tipo_noticia_bd==$id_tipo_noticia){
 		 					$lista_tipo_noticia .= "<option value=\"$id_tipo_noticia_bd\" selected>$descripcion</option>\n";
 		 				}else{
 		 					//echo "sss ";
 		 					$lista_tipo_noticia .= "<option value=\"$id_tipo_noticia_bd\">$descripcion</option>\n";
 		 				}		
		$grupo_noticia =" <select name=\"id_tipo_noticia\" >
		$lista_tipo_noticia 
		 </select>";
...
$contenido .="<br><br>$mensaje
          ...
          <tr><td align=\"center\" class=\"texnormalbold2\" colspan=\"2\"><h3>Men&uacute; Noticia </h3></td></tr>     
	 ...
	 <tr> 
                  <td class=\"textos\" width=\"49%\" align=\"left\">&nbsp;Tipo Noticia</td>
                  <td class=\"textos\" width=\"51%\" align=\"left\"> 
                    $grupo_noticia
    </td>
    </tr>
	...
	<tr> 
                  <td class=\"textos\" width=\"49%\" align=\"left\">&nbsp;Men&uacute;</td>
