...
header("Expires: 0");*/
 ...
 //echo $query_vta;
         $result_vta= mysql_query($query_vta)or die (error($query_vta,mysql_error(),$php));
     ...
     $result_vta2= mysql_query($query_vta)or die (error($query_vta,mysql_error(),$php));
     ...
     $valor_tot=0;
	  ...
	  while (list($id_prod,$cant) = mysql_fetch_row($result_vta2)){
			  ...
			  $query_prod= "SELECT nombre_producto,descripcion,precio_oferta     
                 ...
                 $result_prod= mysql_query($query_prod)or die (error($query_prod,mysql_error(),$php));
