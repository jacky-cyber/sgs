...
class Securimage {
   ...
   * @var mixed
   */
  var $gd_font_file = 'images/gdfonts/bubblebath.gdf';
  ...
  function validate()
  {
    if ( isset($_SESSION['securimage_code_value']) && !empty($_SESSION['securimage_code_value']) ) {
      if ( $_SESSION['securimage_code_value'] == strtolower(trim($this->code_entered)) ) {
        ...
        $nom_session = "sess_capt_".$id_sesion;
        session_register($nom_session);
        $_SESSION[$nom_session] =$_SESSION['securimage_code_value'] ;
