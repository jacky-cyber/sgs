...
if($borrar=="" ){
   ...
   /*
$tablas_reinicio = configuracion_cms('tablas_verifica');

echo $tablas_reinicio;
...
$contenido = "<table width=\"98%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
                <tr>
				  ...
				  <font color=\"#FF0000\"><h1>Esta operaci&oacute;n  borrar&aacute; todo registro del Sgs ¿est&aacute; 100% seguro de realizarla'?</h1></font> 
				  </td>
                </tr>
