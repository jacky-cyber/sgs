...
(function() {
	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		init : function(ed, url) {
			...
			t.languages = {};
			each(ed.getParam('spellchecker_languages', '+Spanish=es,English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv', 'hash'), function(v, k) {
				if (k.indexOf('+') === 0) {
					k = k.substring(1);
					t.selectedLang = v;
				}
