...
//$titulo2_corto = htmlentities($titulo2_corto);
...
if($foto_u==1 and $id_imagen!=""){
 ...
 //echo "$query<br>";
    ...
    <a href=\"index.php?accion=$accion&act=5&id_contenido=$id_contenido\" ><p class=\"$clase_bajada\">$titulo2_corto</p></a>
		   ...
		   <tr><td align=\"right\" valign=\"middle\" class=\"textos_simple\"> <a href=\"index.php?accion=$accion&act=5&id_contenido=$id_contenido\">
                               ($click lecturas) <img src=\"images/breadcrumb.gif\" alt=\"\" border=\"0\"></a></td></tr> 
