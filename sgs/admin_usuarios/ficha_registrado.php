<?php
    ...
    $contenido = html_template('ficha_usuario');
	
	
	
	$contenido = cms_replace("#SOLICITANTE#","$nombre $paterno $materno",$contenido);
...
$contenido = cms_replace("#CANT_PAGINAS#","", $contenido);
		$contenido = cms_replace("#PAGINACION#","", $contenido);
