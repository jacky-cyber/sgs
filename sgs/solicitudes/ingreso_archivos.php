	...
	if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(strlen($name))
		{
			...
			if(in_array($ext,$valid_formats))
			{
				...
				$qry_insert="INSERT INTO sgs_solicitudes_documentos (folio,archivo_solicitudes_doc,id_usuario,observacion_solicitudes_doc,id_solicitud_documentos_tipo,id_archivo_origen)
				VALUES ('$folio','$name',$id_usuario,'$obs','$tipo_doc','$documento_origen')";
