<?php
	...
	$accion_form_archivo = "index.php?accion=$accion&act=3";
...
<script>
			$(document).ready(function(){
				...
				$('#btnguardar').live('click', function(){
					...
					/*if($(\"#archivodoc\").val()!='' && $(\"#tipo_documento\").val()!=''){
...
";
	...
	if(!$id_doc){
		$boton_guardar = "<input type=\"submit\" id=\"btnguardar\" name=\"btnguardar\" value=\"Guardar\"/>";
...
$formulario = html_template('formulario_lista_archivos');
$formulario= cms_replace("#FILE_DOCUMENTO#",$inputfile,$formulario);
$formulario= cms_replace("#OBSERVACION#",$observacion,$formulario);
$formulario= cms_replace("#TEMA_ARCHIVO#",$opciones_combo,$formulario);
$formulario= cms_replace("#VERSION_ARCHIVO#",$versiones_archivo,$formulario);
