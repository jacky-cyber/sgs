...
$tabla = "sgs_entidades_oficinas";
$campo_id  = campo_pk_tabla($tabla);
$campo_txt = campo_txt($tabla);

$titulo_administracion="Administraci&oacute;n Oficinas";
...
$condicion_filtro=" and  id_entidad_padre = '$id_entidad_padre' ";
...
$formulario = "<table width=\"450\"  border=\"0\" align=\"center\" cellpadding=\"2\" cellspacing=\"2\" class=\"cuadro_light\">
				   ...
				   <strong>Ingreso de Oficinas por Servicio </strong></td></tr> 
				   <tr >
                     <td align=\"left\" class=\"textos\">Oficina</td>
					 <td align=\"left\" class=\"textos\"><input type=\"text\" name=\"oficina\" id=\"oficina\" value=\"$oficina\"></td> 
                  </tr>
				  <tr>
				 ...
				 <tr>
					 ...
					 <input type=\"hidden\" name=\"id_entidad_oficina\" id=\"id_entidad_oficina\" value=\"$id\">
...
//$contenido .="<br><br><br><br><br><br><br><br><br>";
