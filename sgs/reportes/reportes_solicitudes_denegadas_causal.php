...
// aca van las caracteristicas de las solicitudes incluidas las consultas
	...
	$titulo_prefijo = "Solicitudes denegadas seg&uacute;n causal ";
	$titulo_prefijo2 = " denegadas seg&uacute;n  causal ";
	$estados = "21,22";
	if ($periodo!=""){
	...
	if ($id_estado_solicitud==""){
		$condicion = $condicion." and a.id_sub_estado_solicitud in ($estados)";
	}else{
	...
	switch ($nivel) {
		...
		case "Solicitud":
		 	$titulo_informe = "Solicitudes ".$titulo_prefijo2." por per&iacute;odo (Detalle)";
			//encabezados	
