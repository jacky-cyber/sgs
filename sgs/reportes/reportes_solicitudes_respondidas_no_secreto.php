...
// aca van las caracteristicas de las solicitudes incluidas las consultas
	...
	$titulo_prefijo = "Solicitudes respondidas sin reserva/secreto ";
	$titulo_prefijo2 = " respondidas sin reserva/secreto ";
	$estado_secreto = "13,14,15,16,17,18,19,20,21,23,24,27,28,29";
	if ($id_estado_solicitud==""){
		$condicion = $condicion. " and a.id_sub_estado_solicitud in ($estado_secreto)";
	}else{
