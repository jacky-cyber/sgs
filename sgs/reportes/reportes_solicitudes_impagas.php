...
// aca van las caracteristicas de las solicitudes incluidas las consultas
	...
	$titulo_prefijo = "Solicitudes impagas ";
	$titulo_prefijo2 = " impagas ";
	$estado_secreto = "14";
	$condicion = " and a.id_sub_estado_solicitud in ($estado_secreto)";
	if ($periodo!=""){
	...
	switch ($nivel) {
		 case "Servicio":
				 $titulo_informe = $titulo_prefijo." por peri&acute;odo (Resumen por Servicio)";
				...
				$encabezado = cms_replace("#FILTRO_CATEGORIA#","$filtro_categoria",$encabezado);
			  	...
			  	$_SESSION['encabezados_mail'] = $encabezado_servicio.$encabezado_entidad.$encabezado_periodo;
				$_SESSION['encabezados_csv'] = acentos_inverso($csv_encabezado_servicio.$csv_encabezado_entidad.$csv_encabezado_periodo);
