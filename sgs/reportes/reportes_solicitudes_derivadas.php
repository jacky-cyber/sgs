...
// aca van las caracteristicas de las solicitudes incluidas las consultas
	...
	$estados = "24";
	$condicion = " and a.id_sub_estado_solicitud in ($estados)";
	$titulo_prefijo = "Solicitudes Derivadas ";
	$titulo_prefijo2 = " derivadas ";
	...
	switch ($nivel) {
		 case "Servicio":
				 $titulo_informe = $titulo_prefijo." seg&uacute;n per&iacute;odo (Resumen por Servicio)";
				...
				$query = "SELECT a.id_entidad_padre, 
							...
							FROM sgs_entidades b, 
								...
								left outer join usuario c on a.id_usuario = c.id_usuario
								left outer join sgs_solicitud_acceso_categoria d on d.folio = a.folio
							WHERE a.id_entidad_padre = b.id_entidad_padre ".$condicion.$condicion_geografica." 								
		 ...
		 case "Entidad":
				...
				$titulo_informe = $titulo_prefijo." seg&uacute;n per&iacute;odo (Resumen por Entidad)";
		...
		case "Detalle":
			...
			$titulo_informe = "Detalle de la solicitud";
			//encabezados	
