...
// aca van las caracteristicas de las solicitudes incluidas las consultas
	...
	$titulo_prefijo = "Solicitudes respondidas con reserva/secreto ";
	$titulo_prefijo2 = " respondidas con reserva/secreto  ";
	$estado_secreto = "22";
	...
	switch ($nivel) {
		...
		case "Solicitud":
		 	$titulo_informe = "Solicitudes ".$titulo_prefijo2." según per&iacute;odo (Detalle)";
			//encabezados	
