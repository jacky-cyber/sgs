...
<?php
	...
	//The file Data/getXMLFromDatabase.php is already UTF-8 encoded having BOM 
	
	//Create the chart - Column 2D Chart 
	echo renderChart("../../FusionCharts/Column2D.swf", "Data/getXMLFromDatabase.php", "", "myFirst", 500, 400, false, false);
?>
<BR><BR>
