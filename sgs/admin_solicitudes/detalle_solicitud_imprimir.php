<?php
	...
	$folio = $_GET['folio'];
		...
		$query= "SELECT id_solicitud_acceso,folio,id_entidad,id_entidad_padre,identificacion_documentos,notificacion,id_forma_recepcion,oficina,id_formato_entrega,fecha_inicio,fecha_termino,orden,id_estado_solicitud,id_sub_estado_solicitud,id_responsable,fecha_formulacion,id_digitador,hash   
				  FROM sgs_solicitud_acceso
				  WHERE folio ='$folio'";
		//and id_usuario=$id_usuario

		$result= cms_query($query)or die ("ERROR $php <br>$query.<br>".mysql_error());
		list($id_consulta,$folio_consulta,$id_entidad,$id_entidad_padre,$consulta,$notificacion,$id_forma_recepcion,$oficina,$id_formato_entrega,$fecha_inicio,$fecha_termino,$orden,$id_estado_solicitud,$id_sub_estado_solicitud,$id_responsable,$fecha_formulacion,$id_digitador,$hash) = mysql_fetch_row($result);
