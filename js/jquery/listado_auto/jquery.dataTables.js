...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnLanguageProcess( oSettings, oLanguage, bInit )
		{
			...
			_fnMap( oSettings.oLanguage, oLanguage, 'sSearch_help' );
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" />'+oSettings.oLanguage.sSearch_help;
