...
function writeCalendarContent()
{
	...
	for(var no=1;no<=daysInMonth;no++){
		...
		cell.innerHTML = no;//imprime el numero
		//si la fecha es posterior a hoy no hace el comando siguiente
		var h = new Date();
		var mes = parseFloat(h.getMonth());
		//mes = mes + 1;
		/* (no == 1){
			alert("mes:"+mes+"  currentMonth:"+currentMonth+"   año:"+h.getYear());
		}*/
		
	//	if (( mes >= currentMonth  &&   h.getYear() >= currentYear) || (h.getDate()>= no && mes == currentMonth &&  h.getYear() == currentYear) ){
	  /*if ( mes > currentMonth  &&   h.getFullYear() >= currentYear) {
